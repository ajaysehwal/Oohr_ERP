...
const FeeReceipt=(props:FeeReceiptProps) => {
  ...
  const [schooladdress,setschooladdress]=useState({
    ...
    const FeeData = [
        {
            name: 'Tuition Fee',
            amount: Number(data.tuition_amount),
        },
        {
            name: 'Admission Fee',
            amount: Number(data.admission_amount),
        },
        {
            name: 'Exam Fee',
            amount: Number(data.exam_amount),
        },
        {
            name: 'Sports Fee',
            amount: Number(data.sports_amount),
        },
        {
            name: 'Transport Fee',
         amount: Number(data.transport_amount),
        },
    ];
    ...
    return (
        <>
            <div ref={covertpdf} className="w-[100%] md:w-[80%] lg:w-[90%] m-auto p-5  border">
                ...
                <hr />
                <br  />
                <p className="text-blue-600 font-bold uppercase flex align-middle justify-end">Recipt No: {data.token}</p>
                <p className="text-graydark font-bold  flex align-middle justify-end">Date: 10/Aug/2023</p>
                 ...
                 <div>
                     ...
                     <p className='font-bold'>Name </p>  <div style={{borderBottom:'1px dotted black',width:'100%'}} className='text-blue-500'> <p className='text-blue-700 ml-2'>{data.student_name} </p> </div>
                     </div>
                     
                     <div className='flex align-middle justify-normal w-full text-1xl mt-0 md:mt-2 lg:mt-2'>
                     <p className='w-40 md:w-30 lg:w-34 font-bold'>Father's Name </p>  <p style={{borderBottom:'1px dotted black',width:'100%'}} className='text-blue-500'> <p className='text-blue-700 ml-2'>{data.father_name}</p> </p>
                     </div>
                  ...
                  <div className='flex align-middle justify-normal w-full text-1xl'>
                     <p className='font-bold'>Class </p>  <div style={{borderBottom:'1px dotted black',width:'100%'}} className='text-blue-500'> <p className='text-blue-700 ml-2'>{data.student_class}</p> </div>
                     </div>
                     <div className='flex align-middle justify-normal w-full text-1xl'>
                     <p className='font-bold'>Month </p>  <div style={{borderBottom:'1px dotted black',width:'100%'}} className='text-blue-500'> <p className='text-blue-700 ml-2'>{data.months}</p> </div>
                     </div>
                  </div>
