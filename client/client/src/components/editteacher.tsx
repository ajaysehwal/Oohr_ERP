...
export default function Teacheredit({data}) {
  ...
  const postdata=async(data:any)=>{
        ...
        setupdateload(true);
          try{
      const res=await axios.put(`${url}/teacherupdate/${teacher_code}`,data);
  ...
  const updatedstudentdoc=async()=>{
      if(selectedFile1){
        ...
        const res=await axios.put(`${url}/teacherdoc/${teacher_code}`,studentdoc,{
          headers: {
  ...
  const updatedstudentimg=async()=>{
    if(selectedFile2){
      ...
      const res=await axios.put(`${url}/teacherimg/${teacher_code}`,studentimg,{
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
 ...
 <ToastContainer></ToastContainer>
    ...
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 p-5">
          <div className="mb-3">
            <label
